...
set_defaults()
{
  ...
  # Generate a new 2048 bit RSA keypair for broker authentication.
  randomized=$(openssl genrsa 2048)
  broker && broker_auth_priv_key="${CONF_BROKER_AUTH_PRIV_KEY:-${randomized}}"
